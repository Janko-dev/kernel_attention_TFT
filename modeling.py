...
class InterpretableMultiHeadAttention(nn.Module):
    def __init__(self, config, _attention: nn.Module=DotProductAttention()):
        super().__init__()
...
# class InterpretableMultiHeadAttention2(nn.Module):
#     def __init__(self, config):
#         super().__init__()
#         self.n_head = config.n_head
#         assert config.hidden_size % config.n_head == 0
...
class TFTBack(nn.Module):
    def __init__(self, config, _attention: nn.Module=DotProductAttention()):
        ...
        self.attention = InterpretableMultiHeadAttention(config, _attention)
...
class TemporalFusionTransformer(nn.Module):
    ...
    """
    def __init__(self, config, _attention_module: nn.Module=DotProductAttention()):
        super().__init__()

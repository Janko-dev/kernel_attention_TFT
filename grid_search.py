...
def main(args):
    ...
    attn_hparam_grid = get_attention_hparam_grid(args.attn_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, required=True, choices=CONFIGS.keys(),
                        help='Dataset name')
    parser.add_argument("--attn_name", type=str, required=True, choices=get_attention_names(),
                        help="Attention module name.".format(",".join(get_attention_names())))
